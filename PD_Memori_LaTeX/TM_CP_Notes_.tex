...
\begin{figure}
	...
	\caption{Saldo \texttt{TOTAL}  \textit{ordenat} del professorat any 2018 amb \textit{model actual} {\color{blue!70}$\blacksquare$} i \textit{model optimització} {\color{orange!70!red!90}$\blacksquare$}. Cada columna representa el saldo d'un professor, les columnes han sigut ordenades de més petita a més gran tenint en compte el signe, respecte el \textit{model actual}. }
	\label{fig:6}
\end{figure}
Això seria el que actualment s'intenta minimitzar. Programant en Python obtenim els resultats que es veuen en les figures 4 i 5.
