...
No obstant una implementació \textit{a priori} de subhastes de Vickrey per obtenir una subhasta optima o satisfactòria no podria ser  per ser factible no hauria de ser seqüencial ja que llavor l'experiència del usuari podria ser desagradable ja que cada \textit{assignatura} hauria d'estar 
