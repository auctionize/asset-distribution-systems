...
\end{tabular}
    ...
    {
	\textbf{Figura (B:3):} 
	{\footnotesize Graaaàfic de la funció $f_3(x)=x^2$.}}
\\
...
\\ 
{
	...
	{\footnotesize Gràfic de la funció $f_4(x)=...$.}} \nehh{On começa cada una}
\\
Això seria el que actualment s'intenta minimitzar. Programant en Python obtenim els resultats que es veuen en les figures [] i [].
