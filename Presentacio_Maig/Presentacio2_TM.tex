...
%Diapositiva 6 (2.)
\begin{frame}{Definició de subhasta òptima}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
...
\begin{frame}{Problemes}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
...
\begin{frame}{Solució}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
...
\begin{frame}{El gran problema}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
...
\begin{frame}{La gran solució}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
...
\begin{frame}{Anàlisis de l'algoritme}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
...
\begin{frame}{Spoiler: No hi ha medalla per nosaltres}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
...
\begin{frame}{L'algoritme no és perfecte però és bo}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
...
\begin{frame}{Recerca futura}\setbeamercolor{block title}{use=structure,fg=white,bg=green!75!black}
